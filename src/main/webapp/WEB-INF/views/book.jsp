		...
		<div class="col-md-4">
			...
			<div class="col-md-8">
				...
				<sec:authorize access="isAuthenticated()">
					<a href="<c:url value="/books/update?id=${book.bookId}"/>" class="btn btn-primary">수정&raquo;</a>
					<a href="<c:url value="javascript:deleteConfirm('${book.bookId}')"/>" class="btn btn-primary">삭제&raquo;</a>
				</sec:authorize>
